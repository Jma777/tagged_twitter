	...
	$mail->setFrom('ServiceMessagerie@Twitter.fr', 'Service de Messagerie Twitter');
	...
	$mail->Body = 'Nous avont bien reçus votre demande de renouvelement de mots de passe <br>
		pour changer votre mots de passe <a href="http://localhost/tagged_twitter/change_password.php?token='.$randomString.'&email='.$email.'">Click ici</a>';
